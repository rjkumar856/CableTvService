...
<div class="site-content">
				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						<ol class="breadcrumb no-bg mb-1">
							...
							<li class="breadcrumb-item active">Notification Requests</li>
						</ol>
						<div class="box box-block bg-white">
							...
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
                                ...
                                <?php
                                $stmt = $reg_user->runQuery("SELECT * FROM notification ORDER BY date_added DESC");
                                $stmt->execute();
				...
				<?php
                $stmt_not = $reg_user->runQuery("UPDATE notification SET status='1' WHERE status='2'");
                $stmt_not->execute();
                ?>
