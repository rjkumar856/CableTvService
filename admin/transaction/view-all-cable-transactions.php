					...
					<div class="container-fluid">
						...
						<div class="box box-block bg-white">
							...
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								...
								<tbody>
                            <?php
                            $stmt = $reg_user->runQuery("SELECT *,wt.id as PaymentID FROM wvc_transaction wt INNER JOIN user us ON us.id=wt.user_id INNER JOIN cable_package cp ON cp.id=wt.Package_id LEFT JOIN user_as_smartcard ua ON ua.user_id=us.id WHERE wt.Package_type='2' ORDER BY wt.created_at DESC");
                            $stmt->execute();
