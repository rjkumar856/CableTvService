...
<style>
.u-img.img-cover{background: url(https://www.admin.webliststore.in/img/logo.png) #cecece center;background-repeat: no-repeat;}
...
?>
                            <div class="col-md-4">
                                <div class="box bg-white user-1">
                                    <div class="u-img img-cover" style="background-image: url(https://www.worldvisioncable.in/assets/images/logo.png);"></div>
                                    <div class="u-content">
                                        <div class="avatar box-64">
                                            
                                        </div>
                                        <h5><a class="text-black" href="#"><?php echo $stmt1->name;?></a></h5>
                                        <p class="text-muted pb-0-5" style="text-transform:uppercase"><?php if($stmt1->role == 1)echo "Admin";?></p>
