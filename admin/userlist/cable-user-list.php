				...
				<div class="content-area py-1">
					<div class="container-fluid">
						...
						<div class="box box-block bg-white">
                            ...
                            LEFT JOIN user_as_smartcard uas ON uas.user_id=us.id LEFT JOIN profile pr ON us.id = pr.user_id INNER JOIN cable_package cp ON uc.package_id=cp.id WHERE us.card_no!='0' ORDER BY ABS(us.card_no) ASC");
                            $stmt->execute();
                            ...
                            <td class="jsgrid-cell jsgrid-control-field jsgrid-align-center" style="width: 50px;">
								...
								<a href="/edit-cable-user-list?id=<?php echo $stmt1->UsrID;?>"><i class="fa fa-external-link" aria-hidden="true" title="Change Plan"></i></a>
										...
										<td><?php
                                            ...
                                            ?></td>
                                            <td><a class="btn btn-primary" href="/add-cable-payment-list?id=<?php echo $stmt1->UsrID;?>">Add Payment</a></td>
										</tr><?php $count++; } ?>
								</tbody>
							</table>
						</div>
