...
<p id="pass1" style="color: red"></p>
								...
								<div class="form-group">
									<input type="email" class="form-control" name="email" value="" id="input-email" pattern="[a-zA-Z][\w\.-]*[a-zA-Z0-9]@([a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z])" placeholder="Email" required="required" >
								</div>
								<div class="form-group">
