...
if (isset($_POST['forgot_password'])) 
{
    ...
    $stmt = $user->runQuery("SELECT id FROM tbl_admin_customers WHERE cusEmail=:email LIMIT 1");
    ...
    if($stmt->rowCount() == 1)
    {
        ...
        $stmt = $user->runQuery("UPDATE tbl_admin_customers SET cusCode=:code WHERE cusEmail=:email");
